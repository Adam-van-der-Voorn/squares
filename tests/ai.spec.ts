import { getBestMove } from '../src/worker_ai/x_lib';
import { test } from '@playwright/test';
import { aiTest } from './lib';
...
test('ai holds of on completing half open tunnel so it can claim bigger one', async ({ page }) => {
    const state = {
        "rows":5,
        "cols":5,
        "moves":[
            "2,1h","2,4v","2,2h","0,4v","4,2v","0,1h","4,4h","5,1v","3,4h","3,2h","2,4h","2,2v","1,3h","4,1h",
            "1,1h","0,3h","3,1h","2,0h","3,0h","3,5h","4,0h","1,0h","0,0h","4,3v","0,2h","0,3v","1,4v","5,4v",
            "3,3v","3,3h","2,3v","3,2v","2,3h","5,2v","3,2v","5,0v","5,2v","1,2h","4,4v","3,4v","2,5h","4,5h",
